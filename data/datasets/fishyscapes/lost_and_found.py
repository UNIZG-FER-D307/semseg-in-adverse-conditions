...
fishy_lf_mean = np.array([0.46310561, 0.50435602, 0.43967894])
fishy_lf_std = np.array([0.23764705, 0.23198072, 0.23845464])
...
class FishyscapesLostAndFound(data.Dataset):
    def __init__(
        self, root, image_transform=None, target_transform=None, joint_transform=None
    ):
        self.root = root
